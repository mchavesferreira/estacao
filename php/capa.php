...
<div class="container" id="slider-container">
      <div id="slider" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="img/bannera.png" class="d-block w-100" alt="Casa 1" />
          ...
          <div class="carousel-item">
            <img src="img/bannerb.png" class="d-block w-100" alt="Casa 2" />
            <div class="carousel-caption">
              <h5>Processo</h5>
              <a href="#" class="btn btn-dark">Ver Projeto</a>
            </div>
          ...
          <div class="carousel-item">
            <img src="img/banner5.jpg" class="d-block w-100" alt="Casa 3" />
            <div class="carousel-caption">
              <h5>Integração</h5>
              <a href="#" class="btn btn-dark">Ver Projeto</a>
            </div>
        ...
        <div class="row">
          <div class="col-12 col-md-4">
            <div class="card text-center">
              ...
              <div class="card-body">
                <h5 class="card-title primary-color">Campus Inteligente</h5>
          ...
          <div class="col-12 col-md-4">
            <div class="card text-center">
              ...
              <div class="card-body">
                <h5 class="card-title primary-color">Cidade Inteligente</h5>
                <p class="card-text secondary-color">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                </p>
                <a href="#" class="btn btn-dark">Saber Mais</a>
    ...
    <div class="container" id="featured-container">
      <div class="col-12">
        <h2 class="title primary-color">Projetos em Desenvolvimento</h2>
        <p class="subtitle secondary-color">
          Conheça nossos projetos em implantação:
        </p>
      </div>
    ...
    <div class="container" id="info-container">
      <div class="col-12">
        ...
        <p class="subtitle secondary-color">
          Conheça os dados monitorados em tempo real em projetos desenvolvidos em aplicações dos conceitos Campus Inteligente, Cidades Inteligentes e Campo Inteligente
        </p>
      </div>
      <div class="col-12">
        <div class="row">

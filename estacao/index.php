...
<div class="d-block d-sm-none navbar-padding-bottom">
    <ul class="jsMenu nav justify-content-around align-items-center fixed-top menu-topo-navegacao menu-bg">
        <li class="nav-item">
            <a href="#">
                <img src="images/icones-menu/svg/icone-logotipo-cinza.svg" alt="Início" class="logotipo">
            </a>
        </li>
    ...
    <div class="col-md-10 col-lg-8 col-12 mx-auto">
        <div class="text-center pb-5">
            <h1 class="text-secondary font-weight-bold">
                Monitoramento de temperatura, umidade e nível pluviométrico
            </h1>
            <h5 class="text-secondary pt-3">
                Gráficos que disponibilizam dados coletados das estações meteorológicas instaladas no campus do IFSP Catanduva para auxílio no monitoramento do clima
            </h5>
        </div>
    </div>
                ...
                <div class="card-sensor h-100">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="p-1">
                            ...
                            <p class="m-0 card-sensor-subtitle">Estação Cetesb Catanduva</p>
                        </div>
                    </div>
                </div>
            </a>
                ...
                <div class="card-sensor h-100">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="p-1">
                            ...
                            <p class="m-0 card-sensor-subtitle">Partículas inalaveis Cetesb Catanduva</p>
                        </div>
                    </div>
                </div>
            </a>
                ...
                <div class="card-sensor h-100">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="p-1">
                            ...
                            <p class="m-0 card-sensor-subtitle">Monóxido de Nitrogênio</p>
                        </div>
                    </div>
                </div>
            </a>
            ...
            <a class="link text-decoration-none estilo-card-default" data-sensor-id="4" title="tab_sensor_4">
                <div class="card-sensor h-100">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="p-1">
                            <p class="m-0 card-sensor-tag">SENSOR</p>
                            <p class="m-0 card-sensor-title">Ozônio </p>
                            <p class="m-0 card-sensor-subtitle">Ozônio</p>
                        </div>
                    </div>
                </div>
            </a>
                ...
                <div class="card-sensor h-100">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="p-1">
                            ...
                            <p class="m-0 card-sensor-subtitle">Radiação Solar Global</p>
                        </div>
                    </div>
                </div>
            </a>
                ...
                <div class="card-sensor h-100">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="p-1">
                            ...
                            <p class="m-0 card-sensor-subtitle">Pressão Atmosférica</p>
                        </div>
                    </div>
                </div>
            </a>
                    ...
                    <div class="col-12 col-md-12">
                        <div class="card p-3 mt-1">
                            <p class="card-title m-0 text-center text-secondary">
                                O nível pluviométrico é a quantidade de chuva por metro quadrado                            </p>
                        </div>
                    </div>
                </div>
                    </div>
            ...
            <div class="card mb-2">
                ...
                <div class="col-md-11 col-lg-12 mx-auto col-12">
                    ...
                    <div class="col-12 col-md-12">
                        <div class="card p-3 mt-1">
                            <p class="card-title m-0 text-center text-secondary">
                                Umidade do ar ideal para o ser humano é acima de 60%                            </p>
                        </div>
                    </div>
                </div>
                    </div>
            ...
            <div class="card mb-2">
                ...
                <div class="col-md-11 col-lg-12 mx-auto col-12">
                    ...
                    <div class="col-12 col-md-12">
                        <div class="card p-3 mt-1">
                            <p class="card-title m-0 text-center text-secondary">
                                Temperatura ideal para o ser humano gira em torno de 18 ºC e 24 ºC                            </p>
                        </div>
                    </div>
                </div>
                    </div>
